import*as a from"https://unpkg.com/three@0.165.0/build/three.module.js";import{Timer as R}from"https://unpkg.com/three@0.165.0/examples/jsm/misc/Timer.js";(function(){const d=document.createElement("link").relList;if(d&&d.supports&&d.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))x(o);new MutationObserver(o=>{for(const l of o)if(l.type==="childList")for(const u of l.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&x(u)}).observe(document,{childList:!0,subtree:!0});function P(o){const l={};return o.integrity&&(l.integrity=o.integrity),o.referrerPolicy&&(l.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?l.credentials="include":o.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function x(o){if(o.ep)return;o.ep=!0;const l=P(o);fetch(o.href,l)}})();const b={name:"RayMarch",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		}`},C=75;n;let F=new a.Scene,W=new a.Scene;const w=new a.OrthographicCamera(-1,1,1,-1,0,1),s=new a.WebGLRenderer;s.setSize(window.innerWidth,window.innerHeight);s.autoClear=!1;document.body.appendChild(s.domElement);const p=new a.WebGLRenderTarget(window.innerWidth,window.innerHeight,{format:a.RGBAFormat,type:a.FloatType}),i=new a.ShaderMaterial({uniforms:{tDiffuse:{value:p.texture}},vertexShader:b.vertexShader,fragmentShader:b.fragmentShader,depthWrite:!1}),H=new a.Mesh(new a.PlaneGeometry(2,2,1,1),i);F.add(H);const y=new a.ShaderMaterial({uniforms:{tDiffuse:{value:p.texture}},vertexShader:S.vertexShader,fragmentShader:S.fragmentShader,depthWrite:!1}),I=new a.Mesh(new a.PlaneGeometry(2,2,1,1),y);W.add(I);const D=new R,m=new a.Vector2,f=new a.Vector2;document.addEventListener("mousemove",function(r){m.x=r.clientX/window.innerWidth,m.y=1-r.clientY/window.innerHeight,f.x=r.pageX,f.y=r.pageY,k.style.left=f.x+"px",k.style.top=f.y+"px"});document.addEventListener("click",function(r){!v&&t<999&&(O(),v=!0)});addEventListener("resize",()=>{console.log("resize"),s.setSize(window.innerWidth,window.innerHeight)},!1);var N=60,g,M=Date.now(),T=1e3/N,h;let t,v=!1;const k=document.getElementById("cursorUI"),c=document.getElementById("cursorText"),e=document.getElementById("cursorImage"),A=new a.Vector2(window.innerWidth,window.innerHeight);function V(r){i.uniforms.iTime={value:r},i.uniforms.screenWidth={value:window.innerWidth},i.uniforms.screenHeight={value:window.innerHeight},i.uniforms.fieldOfView={value:C},i.uniforms.MAX_STEPS={value:100},i.uniforms.SURF_DIST={value:.001},i.uniforms.MAX_DIST={value:20},i.uniforms.absorption={value:2},i.uniforms.orbNumber={value:9}}function z(){const r=new Float32Array(4);switch(s.readRenderTargetPixels(p,m.x*A.x,m.y*A.y,1,1,r),Math.round(r[3]*10)){case 1:t=8;break;case 2:t=7;break;case 3:t=6;break;case 4:t=5;break;case 5:t=4;break;case 6:t=3;break;case 7:t=2;break;case 8:t=1;break;case 9:t=0;break;default:t=1e3;break}i.uniforms.read={value:t},y.uniforms.tDiffuse={value:p.texture}}function E(){s.clear(),s.setRenderTarget(p),s.clear(),s.render(F,w),s.setRenderTarget(null),s.render(W,w)}function _(){var r=r=document.getElementById("closeTab");r&&r.addEventListener("click",function(){L()})}function O(){switch(t){case 0:$("#pageMain").load("pages/page1.html");break;case 1:$("#pageMain").load("pages/page2.html");break;case 2:$("#pageMain").load("pages/page3.html");break;case 3:$("#pageMain").load("pages/page4.html");break;case 4:$("#pageMain").load("pages/page5.html");break;case 5:$("#pageMain").load("pages/page6.html");break;case 6:$("#pageMain").load("pages/page7.html");break;case 7:$("#pageMain").load("pages/page8.html");break;case 8:$("#pageMain").load("pages/page9.html");break}}function L(){var r=document.getElementById("pageMain");r.innerHTML="",v=!1}function B(){switch(t){case 0:c.innerText="About Me",e.style.width="120px",e.src="pages/images/page 1/1.png",e.style.borderWidth="5px";break;case 1:c.innerText="Artemis",e.style.width="150px",e.src="pages/images/page 2/1.png",e.style.borderWidth="5px";break;case 2:c.innerText="Ans",e.style.width="150px",e.src="pages/images/page 3/1.png",e.style.borderWidth="5px";break;case 3:c.innerText="Bounce Bomb Fury",e.style.width="150px",e.src="pages/images/page 4/1.png",e.style.borderWidth="5px";break;case 4:c.innerText="Burning Memory",e.style.width="200px",e.src="pages/images/page 5/1.jpg",e.style.borderWidth="5px";break;case 5:c.innerText="Under Our Wings",e.style.width="150px",e.src="pages/images/page 6/1.png",e.style.borderWidth="5px";break;case 6:c.innerText="Audio-Reactive TV",e.style.width="180px",e.src="pages/images/page 7/1.png",e.style.borderWidth="5px";break;case 7:c.innerText="Boozy Boa",e.style.width="200px",e.src="pages/images/page 8/1.png",e.style.borderWidth="5px";break;case 8:c.innerText="Shader Experiments",e.style.width="150px",e.src="pages/images/page 9/1.png",e.style.borderWidth="5px";break;default:c.innerText="",e.style.width="0px",e.src="",e.style.borderWidth="0px";break}}function U(r){requestAnimationFrame(U),D.update(r);const d=D.getElapsed();g=Date.now(),h=g-M,h>T&&(M=g-h%T,V(d),v?(t=1e3,i.uniforms.read={value:t},y.uniforms.tDiffuse={value:p.texture}):z(),_(),B(),E())}U();
